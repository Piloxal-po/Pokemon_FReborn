  ...
  FLINGDAMAGE = pbHashForwardizer(
    {
      ...
      30 => [:ABILITYURGE, :ABSORBBULB, :ADRENALINEORB, :AMULETCOIN, :ANTIDOTE, :AWAKENING,
             :BALMMUSHROOM, :BERRYJUICE, :BIGMALASADA, :BIGMUSHROOM, *(Gen <= 7 ? [:BIGNUGGET] : []), :BIGPEARL,
...
class PBFields
  ...
  TRASHCLOAK = [
    ...
    :MURKWATERSURFACE, :HOLY, :MIRROR, :NEWWORLD, :INVERSE, :PSYTERRAIN, :DIMENSIONAL, :FROZENDIMENSION, :HAUNTED, :CORRUPTED,
    :CONCERT1, :CONCERT2, :CONCERT3, :CONCERT4, :CROWD, :DANCEFLOOR, :DARKNESS1, :DARKNESS2, :DARKNESS3
  ]
