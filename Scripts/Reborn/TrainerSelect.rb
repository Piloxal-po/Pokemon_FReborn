...
def themeTeamArray
  teams = [
    ...
    { number: 16, trainer: "Amaria", name: "Boss Rush", teamnumber: 10, field: :WATERSURFACE, doubles: $game_switches[881] && !$game_switches[878] || !$game_switches[881] && $game_switches[878] },
    { number: 16, trainer: "Amaria", name: "Boss Rush 2", teamnumber: 11, field: :UNDERWATER, doubles: $game_switches[881] && !$game_switches[878] || !$game_switches[881] && $game_switches[878] },
