...
def pbVictoryRoadPuzzle(number)
  clues = [
    # 3
    [
      "1. Deux cristaux ne peuvent avoir la même propriété.",
      "2. La Dureté du Rubis est 7.",
      "3. Rubis est plus grande qu'Améthyste, mais ce n'est",
      "    pas la plus grande.",
      "4. La Pureté d'Améthyste est Médiocre.",
      "5. La gemme Pure est Moyenne.",
      "6. Émeraude est moins pure que Rubis, mais plus pure",
      "    que Saphir.",
      "7. La plus petite gemme est aussi la moins dure.",
      "8. La Dureté du Saphir est inférieure à celle de",
      "    l'Émeraude.",
      "9. La plus grande gemme est la moins pure."
    ],
    # 4
    [
      "1. Deux cristaux ne peuvent avoir la même propriété.",
      "2. La deuxième gemme la plus dure est Pure.",
      "3. Rubis a plus de Foliation et est plus grande que",
      "    Saphir.",
      "4. Saphir est plus pure qu'Améthyste.",
      "5. La troisième gemme la plus dure est Médiocre.",
      "6. Ni Émeraude ni Améthyste n'est la gemme la plus",
      "    pure ou la moins pure.",
      "7. La gemme la plus dure a la plus grande Foliation.",
      "8. Saphir a moins de Foliation que la gemme Pure,",
      "    laquelle a moins de Foliation qu'Améthyste.",
      "9. Le plus petite gemme est la moins dure.",
      "10. Émeraude est plus petite que Rubis, qui est plus", 
      "     petite qu'Améthyste."
    ],
    # 5
    [
      "1. Deux cristaux ne peuvent avoir la même propriété.",
      "2. Rubis est plus grande que Saphir.",
      "3. Améthyste est moins pure que Rubis,",
      "    et Rubis est moins Pure que Saphir.",
      "4. Améthyste n'a pas un Éclat Vitreux.",
      "5. Rubis a plus d'éclat qu'Améthyste, qui a",
      "    plus d'éclat que Saphir.",
      "6. Améthyste n'est pas Miniscule.",
      "7. Rubis a moins de Foliation que Saphir.",
      "8. La plus grande gemme est plus éclatante que",
      "    la plus petite gemme.",
      "9. La gemme avec une Foliation Difficile est plus",
      "    petite qu'Émeraude.",
      "10. Améthyste a une Foliation Exceptionnelle.",
      "11. Les gemmes sont, par ordre croissant de Dureté :",
      "     La gemme Moyenne, la gemme Médiocre, la gemme",
      "     de plus petite Foliation, la gemme Perlée.",
      "12. Le gemme Indistincte est aussi la moins pure."
    ],
    # First 6
    [
      "1. Deux cristaux ne peuvent avoir la même propriété.",
      "2. La Structure de la deuxième gemme la plus dure est",
      "    inférieure à celle de la gemme Pure, laquelle est",
      "    inférieure à la structure de l'Émeraude.",
      "3. La Pureté de la gemme Vitreuse est inférieure",
      "    à celle de l'Émeraude, laquelle est inférieure",
      "    à celle de la gemme Perlée.",
      "4. L'Éclat de la gemme Minuscule est inférieur à",
      "    celui de la gemme Moyenne, lequel est inférieur",
      "    à celui de la gemme Hexagonale.",
      "5. La Dureté de la Petite gemme est inférieure à",
      "    celle de l'Améthyste, laquelle est inférieure",
      "    à celle de la gemme Pure.",
      "6. L'Éclat de la gemme de Pureté Médiocre est",
      "    inférieur à celui de la gemme Moyenne.",
      "7. La Foliation de la gemme Perlée est inférieure à",
      "    celle de la gemme vitreuse, laquelle est",
      "    inférieure à celle de la gemme Soyeuse.",
      "8. La Structure de la gemme Soyeuse est inférieure",
      "    à celle de la gemme la plus pure.",
      "9. La Taille de la gemme Impure est inférieure à",
      "    celle de la gemme Parfaite, laquelle est",
      "    inférieure celle du Saphir.",
      "10. La Foliation de l'Améthyste est inférieure à",
      "     celle de la deuxième gemme la plus dure,",
      "     laquelle est inférieure à celle du Saphir."
    ],
    # Second 6
    [
      "1. Deux cristaux ne peuvent avoir la même propriété.",
      "2. La Pureté de la gemme Crêtée est inférieure à",
      "celle de la gemme Minuscule, laquelle est inférieure",
      "à celle de la gemme Vitreuse.",
      "3. La Dureté de la gemme Exceptionnelle est",
      "inférieure à celle de la gemme Parfaite, laquelle est",
      "inférieure à celle de la gemme Cubique.",
      "4. The Pureté de la gemme de Dureté of 5 est inférieure",
      "à celle de la gemme Parfaite, laquelle est inférieure",
      "à celle de la gemme Perlée.",
      "5. L'Éclat de la gemme Tabulaire est inférieur à",
      "celui de la gemme Cubique, lequel est inférieur à",
      "celui de la gemme Indistincte.",
      "6. La Taille de la gemme Crêtée est inférieure à",
      "celle de la gemme Indistincte, laquelle est inférieure",
      "à celle de la gemme de Dureté 8.",
      "7. La Foliation de la gemme Hexagonale est inférieure à",
      "celle de la Grande gemme, laquelle est inférieure à",
      "celle de la gemme de Dureté 7.",
      "8. La Structure de la gemme Immaculée est inférieure à",
      "celle de la gemme Perlée, laquelle est inférieure à",
      "celle de la gemme Soyeuse."
    ]
  ]
