ABILHASH = {
  ...
  :THICKFAT => {
    ...
    :fullDesc => "Increases resistance to Fire- and Ice-type moves by 50%."
  },
  ...
  :PICKUP => {
    ...
    :fullDesc => "At the end of each turn, picks up items used by other Pokémon that turn. Also may pick up items at the end of a battle."
  },
