begin
  ...
  class PokemonTilesetScene
    ...
    def pbStartScene
      ...
      @tilehelper = TileDrawingHelper.fromTileset(@tileset)
      @sprites = {}
      @sprites["title"] = Window_UnformattedTextPokemon.new(_INTL("Terrain Tags (PgUp/PgDn: SCROLL; Shift: MENU)"))
      ...
      loop do
        ...
        if Input.repeat?(Input::UP)
          ...
          pbSetSelected(selected, Kernel.pbMessageChooseNumber(_INTL("Set the terrain tag."), params))
          pbUpdateTileset
        end
      end
      ########
